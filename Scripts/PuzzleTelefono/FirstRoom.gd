...
@export var dialogo1 : AudioStream
@export var dialogo2 : AudioStream
@export var dialogo3 : AudioStream
...
func playDialogue(dialogue : AudioStream):
	GameManager.player.UI.MenuPause.dialogue.stop()
	GameManager.player.UI.MenuPause.dialogue.stream = dialogue
	GameManager.player.UI.MenuPause.dialogue.play()
